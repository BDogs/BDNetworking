...
enum PLAppointmentDoctorGetToStartListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLAppointmentDoctorGetToStartListAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLAppointmentDoctorGetToStartListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "appointment/doctor/getToStartList"
    }
}

extension PLAppointmentDoctorGetToStartListAPIManager: BDAPIManagerValidator {
