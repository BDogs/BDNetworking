...
enum PLVideoDoctorSubmitVideoAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLVideoDoctorSubmitVideoAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLVideoDoctorSubmitVideoAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "video/doctor/submitVideo"
    }
}

extension PLVideoDoctorSubmitVideoAPIManager: BDAPIManagerValidator {
