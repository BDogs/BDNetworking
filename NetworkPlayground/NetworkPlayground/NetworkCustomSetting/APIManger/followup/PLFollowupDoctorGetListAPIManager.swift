...
enum PLFollowupDoctorGetListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLFollowupDoctorGetListAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLFollowupDoctorGetListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "followup/doctor/getList"
    }
}

extension PLFollowupDoctorGetListAPIManager: BDAPIManagerValidator {
