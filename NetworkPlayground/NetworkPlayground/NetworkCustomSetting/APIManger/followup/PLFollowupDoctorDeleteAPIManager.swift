...
enum PLFollowupDoctorDeleteAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLFollowupDoctorDeleteAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLFollowupDoctorDeleteAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "followup/doctor/delete"
    }
}

extension PLFollowupDoctorDeleteAPIManager: BDAPIManagerValidator {
