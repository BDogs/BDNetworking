...
enum PLFollowupDoctorAddAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLFollowupDoctorAddAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLFollowupDoctorAddAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "followup/doctor/add"
    }
}

extension PLFollowupDoctorAddAPIManager: BDAPIManagerValidator {
