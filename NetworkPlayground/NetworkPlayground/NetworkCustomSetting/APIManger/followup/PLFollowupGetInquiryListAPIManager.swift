...
enum PLFollowupGetInquiryListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLFollowupGetInquiryListAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLFollowupGetInquiryListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "followup/getInquiryList"
    }
}

extension PLFollowupGetInquiryListAPIManager: BDAPIManagerValidator {
