...
enum PLInquiryDoctorGetServicesDetailAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryDoctorGetServicesDetailAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLInquiryDoctorGetServicesDetailAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/doctor/getServicesDetail"
    }
}

extension PLInquiryDoctorGetServicesDetailAPIManager: BDAPIManagerValidator {
