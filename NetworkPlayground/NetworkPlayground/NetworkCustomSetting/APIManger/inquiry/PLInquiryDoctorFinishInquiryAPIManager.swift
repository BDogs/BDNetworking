...
enum PLInquiryDoctorFinishInquiryAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryDoctorFinishInquiryAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquiryDoctorFinishInquiryAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/doctor/finishInquiry"
    }
}

extension PLInquiryDoctorFinishInquiryAPIManager: BDAPIManagerValidator {
