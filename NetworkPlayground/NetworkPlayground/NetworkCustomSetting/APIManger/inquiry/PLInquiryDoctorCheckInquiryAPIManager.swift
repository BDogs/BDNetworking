...
enum PLInquiryDoctorCheckInquiryAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryDoctorCheckInquiryAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquiryDoctorCheckInquiryAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/doctor/checkInquiry"
    }
}

extension PLInquiryDoctorCheckInquiryAPIManager: BDAPIManagerValidator {
