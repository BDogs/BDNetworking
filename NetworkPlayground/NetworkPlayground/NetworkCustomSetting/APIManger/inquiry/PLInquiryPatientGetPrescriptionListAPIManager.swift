...
enum PLInquiryPatientGetPrescriptionListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryPatientGetPrescriptionListAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquiryPatientGetPrescriptionListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/patient/getPrescriptionList"
    }
}

extension PLInquiryPatientGetPrescriptionListAPIManager: BDAPIManagerValidator {
