...
enum PLInquirySubmitInquiryAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquirySubmitInquiryAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquirySubmitInquiryAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/submitInquiry"
    }
}

extension PLInquirySubmitInquiryAPIManager: BDAPIManagerValidator {
