...
enum PLInquiryDoctorGetInquiryDetailAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryDoctorGetInquiryDetailAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquiryDoctorGetInquiryDetailAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/doctor/getInquiryDetail"
    }
}

extension PLInquiryDoctorGetInquiryDetailAPIManager: BDAPIManagerValidator {
