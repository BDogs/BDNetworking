...
enum PLInquiryGetMedicineListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInquiryGetMedicineListAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInquiryGetMedicineListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquiry/getMedicineList"
    }
}

extension PLInquiryGetMedicineListAPIManager: BDAPIManagerValidator {
