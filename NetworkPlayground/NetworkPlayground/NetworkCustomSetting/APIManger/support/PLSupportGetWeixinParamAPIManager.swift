...
enum PLSupportGetWeixinParamAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLSupportGetWeixinParamAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLSupportGetWeixinParamAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "support/getWeixinParam"
    }
}

extension PLSupportGetWeixinParamAPIManager: BDAPIManagerValidator {
