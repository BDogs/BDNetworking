...
enum PFOPatientPatientUpdateFaceUrlAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PFOPatientPatientUpdateFaceUrlAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PFOPatientPatientUpdateFaceUrlAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "patient/patient/updateFaceUrl"
    }
}

extension PFOPatientPatientUpdateFaceUrlAPIManager: BDAPIManagerValidator {
