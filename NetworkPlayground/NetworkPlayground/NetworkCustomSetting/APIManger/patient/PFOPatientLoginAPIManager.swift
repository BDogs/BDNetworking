...
enum PFOPatientLoginAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PFOPatientLoginAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PFOPatientLoginAPIManager: BDAPIManagerProtocal {
...
extension PFOPatientLoginAPIManager: BDAPIManagerValidator {
