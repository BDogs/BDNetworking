...
enum PLUserSetDefaultAddressAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLUserSetDefaultAddressAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLUserSetDefaultAddressAPIManager: BDAPIManagerProtocal {
...
extension PLUserSetDefaultAddressAPIManager: BDAPIManagerValidator {
