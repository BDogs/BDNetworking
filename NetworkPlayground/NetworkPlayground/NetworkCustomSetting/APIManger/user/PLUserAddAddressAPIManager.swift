...
enum PLUserAddAddressAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLUserAddAddressAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLUserAddAddressAPIManager: BDAPIManagerProtocal {
...
extension PLUserAddAddressAPIManager: BDAPIManagerValidator {
