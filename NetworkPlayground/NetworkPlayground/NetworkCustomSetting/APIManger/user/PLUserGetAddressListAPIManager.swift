...
enum PLUserGetAddressListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLUserGetAddressListAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLUserGetAddressListAPIManager: BDAPIManagerProtocal {
...
extension PLUserGetAddressListAPIManager: BDAPIManagerValidator {
