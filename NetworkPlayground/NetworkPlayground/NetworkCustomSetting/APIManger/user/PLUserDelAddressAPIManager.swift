...
enum PLUserDelAddressAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLUserDelAddressAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLUserDelAddressAPIManager: BDAPIManagerProtocal {
...
extension PLUserDelAddressAPIManager: BDAPIManagerValidator {
