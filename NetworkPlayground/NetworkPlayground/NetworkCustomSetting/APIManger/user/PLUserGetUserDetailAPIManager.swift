...
enum PLUserGetUserDetailAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLUserGetUserDetailAPIManager: BDAPIBaseManager {
    // MARK: - override
    required init() {
        super.init()
        self.validator = self
...
extension PLUserGetUserDetailAPIManager: BDAPIManagerProtocal {
...
extension PLUserGetUserDetailAPIManager: BDAPIManagerValidator {
