...
enum PLInqueryPatientGetInquiryDetailAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInqueryPatientGetInquiryDetailAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInqueryPatientGetInquiryDetailAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquery/patient/getInquiryDetail"
    }
}

extension PLInqueryPatientGetInquiryDetailAPIManager: BDAPIManagerValidator {
