...
enum PLInqueryDoctorGetAllListAPIManagerResponseError: Int, Error, LocalizedError {
    case `default` = 0
...
class PLInqueryDoctorGetAllListAPIManager: BDAPIBaseManager {
    // MARK: - override
    override init() {
        super.init()
        self.validator = self
...
extension PLInqueryDoctorGetAllListAPIManager: BDAPIManagerProtocal {
    ...
    func relativeUrl() -> String {
        return "inquery/doctor/getAllList"
    }
}

extension PLInqueryDoctorGetAllListAPIManager: BDAPIManagerValidator {
