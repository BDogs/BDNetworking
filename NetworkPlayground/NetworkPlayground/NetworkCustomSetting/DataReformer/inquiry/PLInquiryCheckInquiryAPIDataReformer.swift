...
public class PLInquiryCheckInquiryAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let endTime: InfoKey = InfoKey(rawValue: "end_time")
        public static let remainCount: InfoKey = InfoKey(rawValue: "remain_count")
        public static let allowStatus: InfoKey = InfoKey(rawValue: "allow_status")

    }
}

extension PLInquiryCheckInquiryAPIDataReformer: BDAPIManagerDataReformer {
