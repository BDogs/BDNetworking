...
public class PLFollowupGetQuestionListAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let scoreDetail: InfoKey = InfoKey(rawValue: "score_detail")
        public static let id: InfoKey = InfoKey(rawValue: "id")
        public static let score: InfoKey = InfoKey(rawValue: "score")
        public static let finish: InfoKey = InfoKey(rawValue: "finish")

    }
}

extension PLFollowupGetQuestionListAPIDataReformer: BDAPIManagerDataReformer {
