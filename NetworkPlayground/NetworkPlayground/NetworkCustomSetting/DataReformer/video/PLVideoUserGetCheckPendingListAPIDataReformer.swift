...
public class PLVideoUserGetCheckPendingListAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let outpatientStatus: InfoKey = InfoKey(rawValue: "outpatient_status")
...
extension PLVideoUserGetCheckPendingListAPIDataReformer: BDAPIManagerDataReformer {
