...
public class PLVideoDoctorGetServiceListAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let 2019-12-26: InfoKey = InfoKey(rawValue: "2019-12-26")

    }
}

extension PLVideoDoctorGetServiceListAPIDataReformer: BDAPIManagerDataReformer {
