...
public class PLVideoDoctorGetCheckedListAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let reminderTime: InfoKey = InfoKey(rawValue: "reminder_time")
        ...
        public static let sign: InfoKey = InfoKey(rawValue: "sign")
        public static let id: InfoKey = InfoKey(rawValue: "id")
        public static let outpatientName: InfoKey = InfoKey(rawValue: "outpatient_name")
        public static let expectTime: InfoKey = InfoKey(rawValue: "expect_time")

    }
}

extension PLVideoDoctorGetCheckedListAPIDataReformer: BDAPIManagerDataReformer {
