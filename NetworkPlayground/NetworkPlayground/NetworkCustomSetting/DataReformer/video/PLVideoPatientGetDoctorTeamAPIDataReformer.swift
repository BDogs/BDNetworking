...
public class PLVideoPatientGetDoctorTeamAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let childId: InfoKey = InfoKey(rawValue: "child_id")
        ...
        public static let parentId: InfoKey = InfoKey(rawValue: "parent_id")

    }
}

extension PLVideoPatientGetDoctorTeamAPIDataReformer: BDAPIManagerDataReformer {
