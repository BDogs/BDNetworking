...
public class PLAppointmentGetDoctorListAPIDataReformer: NSObject {
    ...
    public struct InfoKey: Hashable, Equatable, RawRepresentable {
        ...
        public static let remotectrlPrice: InfoKey = InfoKey(rawValue: "remotectrl_price")
        ...
        public static let availableCount: InfoKey = InfoKey(rawValue: "available_count")
        public static let faceUrl: InfoKey = InfoKey(rawValue: "face_url")

    }
}

extension PLAppointmentGetDoctorListAPIDataReformer: BDAPIManagerDataReformer {
