//
//  PinsLifeService.swift
//  PinsLife
//
//  Created by 诸葛游 on 2017/10/18.
...
class PinsLifeService: BDService, BDServiceProtocol {
    ...
    var offlineApiBaseUrl: String {
        ...
        case 0: return "http://192.168.1.248:58080/api"
        case 1: return "http://192.168.1.207:8090/api"
        case 2: return "https://pinslife.pinsmedical.com/api"
        default:
            return ""
        }
    }
    ...
    var onlineApiBaseUrl: String {
        return "https://pinslife.pinsmedical.com/api"
    }
